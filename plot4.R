...
plot(strptime(pc$timestamp, "%Y-%m-%dT%H:%M:%S"),pc$Voltage, ylab="Voltage", type="l")

plot(strptime(pc$timestamp, "%Y-%m-%dT%H:%M:%S"),pc$Sub_metering_1, ylab="Energy sub metering", type="l", col='red')
...
plot(strptime(pc$timestamp, "%Y-%m-%dT%H:%M:%S"),pc$Global_reactive_power, ylab="Global reactive power", type="l", col='black')
